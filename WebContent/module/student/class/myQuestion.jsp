...
<input type="hidden" name="imitateStep" value="${paramMap.step}"> 
							...
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
								  <tr bgcolor="#ae9b84">
									...
									<input name="paramMap.title" type="text" maxlength="200" id="title" style="width: 400;" />
								  ...
								  <tr bgcolor="#ae9b84">
									...
									<td width="85%" class="tatd" align="left">
										<textarea cols="80" id="editor1" name="paramMap.content" rows="10" height="100px"></textarea>
									    <script type="text/javascript">
