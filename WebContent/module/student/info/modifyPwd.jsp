...
$(document).ready(function(){
	...
	$("#oldPassword").formValidator({onshow:"请输入原密码",onfocus:"原密码不能为空",oncorrect:"输入正确输入正确"}).inputValidator({min:1,onerror:"原密码不能为空,请确认"});
...
<input type="hidden" name="imitateStep" value="${pmsIndex.student_password_modify.imitationStep}"> 
