...
$(document).ready(function(){	
	...
	$("#userDicType").formValidator({onshow:"请选择密码提示问题",onfocus:"密码提示问题必选",oncorrect:"输入正确"}).inputValidator({onerror: "请选择密码提示问题"});
});
</script>
</head>
<body>
...
<input type="hidden" name="imitateStep" value="${pmsIndex.student_my_persion_data_mgr.imitationStep}"> 
							...
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9" >
								  <tr bgcolor="#ae9b84">
									...
									<input name="paramMap.name" value="${initMap.userInfo.userName}" type="text" maxlength="180" id="cateSign"  style="width: 200px;" />&nbsp;
								  </tr>
								  <tr bgcolor="#ae9b84">
								  ...
								  <tr bgcolor="#ae9b84">
									...
									<input name="paramMap.email" value="${initMap.userInfo.userEmail}" type="text" maxlength="200" id="email" style="width: 200px;" />&nbsp;
								    </td>
								  </tr>
								  <tr bgcolor="#ae9b84">
