...
<input name="paramMap.gaID" type="hidden" id="gaID" value="${initMap.gagelleryInfo.gaID}"/>
							...
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
									 <tr bgcolor="#ae9b84">
										...
										<input type="hidden" name="paramMap.oldResUpload" id="oldResUpload" value="${initMap.gagelleryInfo.erUpload}" >
										<input type="hidden" name="paramMap.erUpload" id="erUpload" value="${initMap.gagelleryInfo.erUpload}">
										</td>
									</tr>
									<tr bgcolor="#ae9b84">
										<td width="15%" class="tatd" align="right" id="exhibition_17">详细说明：</td>
										<td width="85%" class="tatd" align="left">
										<textarea cols="80" id="erDescription" name="paramMap.erDescription" rows="10">${initMap.gagelleryInfo.erDescription}</textarea>&nbsp;
