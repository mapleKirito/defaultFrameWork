...
$(document).ready(
	...
	function changeList(v) {
		...
		window.location.href = "decorateForwardAction.action?code=-701&path="
				+ catePath
				+ "&paramMap.cateLevel="
				+ cateLevel
...
<input type="hidden" id="changeType" value="${paramMap.changeType }">
	<div id="layout_mainbody">
		...
		<div class="page-container">
			...
			<s:if test="initMap.resViewgao.isEmpty()">
				<center>
			...
			<form name="actionForm" method="post"
				...
				>
				<s:if test="initMap.resViewgao.isEmpty()== false">

					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						class="table_to res_info" id="funbig1" style="display: none;">
						<tr>
							<s:iterator value="initMap.resViewgao" id="fv" status="fvindx">
								...
								<td align="center">
									<div id="boxgrid<s:property value=" #fvindx.index " />"
										class="gallery" style="position: relative; top: 5px;">
					...
					#fv.fileType " escape="false " />.gif"
								...
								<td width="45%" class="onlyex" align="left">&nbsp;&nbsp; <a
									onclick="window.parent.frames.showView(this)" name="${fv.name}"
									codeNum="${pcode}"
								...
								<td width="25%" class="onlyex" align="left">&nbsp; <s:if
										...
										<a class="lt-button fade-button"
											...
											预览 </a>
										<a class="lt-button fade-button"
											href="downloadAction.action?code=-706&paramMap.resDownRoom=${fv.resType}&paramMap.resDownType=${fv.fileType}&paramMap.resPath=${fv.rrUpload}">
											资源下载 </a>
									</s:if> <s:if
