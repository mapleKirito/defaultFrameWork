				...
				<td>
					...
					<div class="lt-command">
	 					<s:if test="pmsIndex.res_laboratory_room_create">
	 						<a href="decorateForwardAction.action?code=${pmsIndex.res_laboratory_room_create.code}" class="fade-button" data-old-bg="rgb(124, 109, 91)" style="background-color: rgb(124, 109, 91);">
					 ...
					 <%-- 	<s:if test="pmsIndex.res_laboratory_room_statichtml">
					 	...
					 	<s:if test="pmsIndex.res_laboratory_room_welcome_manager">
					 		<a href="decorateForwardAction.action?code=${pmsIndex.res_laboratory_room_welcome_manager.code}">
