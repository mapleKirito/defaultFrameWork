...
<input name="paramMap.lrID" type="hidden" id="lrID" value="${paramMap.lrID}"/>
<input name="paramMap.rrResourceID" type="hidden" id="rrResourceID" value="${paramMap.lrID}"/>
<input name="paramMap.rrResourceType" type="hidden" id="rrResourceType" value="laboratory"/>
<input name="paramMap.grResourceID" type="hidden" id="grResourceID" value="${paramMap.lrID}"/>
<input name="paramMap.grResourceType" type="hidden" id="grResourceType" value="laboratory"/>
<input name="paramMap.reRecommendID" type="hidden" id="reRecommendID" value="${paramMap.lrID}"/>
<input name="paramMap.reRecommendType" type="hidden" id="reRecommendType" value="laboratory"/>
