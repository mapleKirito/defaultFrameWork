...
$(document).ready(function(){	
  ...
  $.formValidator.initConfig({formid:"actionForm",onerror:function(){},onsuccess:function(){}});//表单提交 
	$("#lrName").formValidator({onshow:"请输入中文名",onfocus:"请输入中文名",oncorrect:"输入正确"}).inputValidator({min:1,onerror:function(){alert("中文名不能为空,请确认");}});
...
function Change(_this){
	 if(_this.checked==true){
		 var resName=$("#lrName").val();		 
		 var lrCateTwLevel =  $('#lrCateTwLevel').val();
		 ...
		 if(attr(resName)  ){				
				if(attr(typeId)){					
					$.createaboutwebox({
						...
						bgvisibel:true,
						title:'教学研究室资源推荐',
						iframe:'<%=request.getContextPath()%>/module/system/res/resRecomm/recomm.jsp?filetype='+lrType+'&name='+resName+'&roomtype='+typeId+'&IsPlan='+lrCateTwLevel+'&'+Math.random
					});
			}else{
						alert("请选择资源类型");
						_this.checked=false;
							...
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
									<tr bgcolor="#ae9b84">
										...
										<td width="85%" class="tatd" align="left"><input name="paramMap.lrName" type="text" maxlength="180" id="lrName" style="width: 200px;" />&nbsp;
									...
									<tr bgcolor="#ae9b84">
										...
										<td width="85%" class="tatd" align="left">
											...
											<select id="cateTwLevel" name="paramMap.lrCateTwLevel" ><option value="">--请选择--</option></select>
											<font color="red">*</font><span id="cateTwLevelTip" style="position:absolute;height:22px;width:297px"></span>
										</td>
								   	</tr>
									<tr bgcolor="#ae9b84">
									...
									<tr bgcolor="#ae9b84" id="laborstylecreate6">
									...
									<tr bgcolor="#ae9b84" >
										...
										<td width="85%" class="tatd" align="left" >
										<input type="checkbox"  name="paramMap.lrIsShare" id="lrIsShare" value="1"  >
										</td>
									</tr>
									...
									<%-- <tr bgcolor="#ae9b84" id="lrContent" >
										<td width="15%" class="tatd" align="right">资源简介：</td>
										<td width="85%" class="tatd" align="left">
											<textarea cols="80" id="editor1" name="paramMap.lrContent" rows="10"></textarea>
										    <script type="text/javascript">
											CKEDITOR.replace('editor1',{ filebrowserUploadUrl : 'ckeditor/uploader?Type=File&TypeRoom=laboratory', filebrowserImageUploadUrl : 'ckeditor/uploader?Type=Image&TypeRoom=laboratory', filebrowserFlashUploadUrl : 'ckeditor/uploader?Type=Flash&TypeRoom=laboratory' });
 											</script>
									...
									<tr bgcolor="#ae9b84">
										...
										<td width="85%" class="tatd" align="left"><input name="paramMap.lrCreateTime" type="text" class="Wdate" maxlength="10" id="lrCreateTime" style="width: 200;" onFocus="WdatePicker({isShowWeek:true,dateFmt:'yyyy-MM-dd',readOnly:true});" />&nbsp;
										</td>
									</tr>
