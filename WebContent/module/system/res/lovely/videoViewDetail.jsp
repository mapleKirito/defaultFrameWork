                         ...
                         <li title="下载">
		                  	...
		                  	<div class="hide-popup popup-rc-cloud-down">
		                          ...
		                          <div class="hide-popup-content">
		                              <table>
		                                  <tr>
		                                      <td class="key keya"><a href="downloadAction.action?code=-706&paramMap.resPath=${initMap.detail.crAudio}">音频下载</a></td>
		                                  </tr>
		                                  <tr>
                            ...
                            <div class="hide-popup popup-rc-info">
                                ...
                                <div class="hide-popup-content">
                                 ...
                                 <tr>
										...
										<td width="75%" align="center" class="erCode">${initMap.detail.crCode}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="75%" align="center" class="erTotal">${initMap.detail.crTotal}</td>
									</tr>
