...
<input name="paramMap.crID" type="hidden" id="crID" value="${paramMap.crID}"/>
<input name="paramMap.rrResourceID" type="hidden" id="rrResourceID" value="${paramMap.crID}"/>
<input name="paramMap.rrResourceType" type="hidden" id="rrResourceType" value="lovely"/>
<input name="paramMap.grResourceID" type="hidden" id="grResourceID" value="${paramMap.crID}"/>
<input name="paramMap.grResourceType" type="hidden" id="grResourceType" value=""lovely""/>
<input name="paramMap.reRecommendID" type="hidden" id="reRecommendID" value="${paramMap.crID}"/>
<input name="paramMap.reRecommendType" type="hidden" id="reRecommendType" value=""lovely""/>
