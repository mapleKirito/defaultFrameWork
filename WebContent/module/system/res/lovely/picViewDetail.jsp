...
<input type="hidden" id="erTotal" value="${initMap.detail.crResTypeName}">
                       ...
                       <li title="下载">
		                  	...
		                  	<div class="hide-popup popup-rc-cloud-down rc-cloud-down">
		                          ...
		                          <div class="hide-popup-content">
		                              <table>
		                                  <tr>
		                                      <td class="key keya"><a id="download" href="downloadAction.action?code=-706&paramMap.resDownRoom=lovely&paramMap.resDownType=${initMap.detail.crType}&paramMap.resPath=${initMap.detail.crUpload}">资源下载</a></td>
		                                  </tr>
		                              </table>
		                          </div>
		                      </div>
                                ...
                                <div class="hide-popup-content">
                                 ...
                                 <tr>
									...
									<tr>
										...
										<td width="75%" align="center" class="crType">${initMap.detail.crType eq "1011" ? '高清图片':(initMap.detail.crType eq "1073" ? '音频':(initMap.detail.crType eq "4033" ? '压缩包':'PDF')) }</td>
									</tr>
									<tr>
                        ...
                        <div class="controll">
                           ...
                           <div class="res-detail-container">
                            <a href="javascript:void(0);" onclick="BigImg('cr')">
                           	 <img onload="if(this.width >= ${session.imgWidth}){this.height=(this.height/this.width)*${session.imgWidth};this.width = ${session.imgWidth};}if(this.height >= ${session.imgHeight}){this.width=(this.width/this.height)*${session.imgHeight};this.height = ${session.imgHeight};}" id="resView" src="${initMap.detail.crInThum}"  upload='${initMap.detail.crUpload}'  _index="0"/>
                            </a>
                        </div>
                    </div>
                    <!--资源详细结束-->
