...
<input name="paramMap.prID" type="hidden" id="prID" value="${paramMap.prID}"/>
<input name="paramMap.rrResourceID" type="hidden" id="rrResourceID" value="${paramMap.prID}"/>
<input name="paramMap.rrResourceType" type="hidden" id="rrResourceType" value="projection"/>
<input name="paramMap.grResourceID" type="hidden" id="grResourceID" value="${paramMap.prID}"/>
<input name="paramMap.grResourceType" type="hidden" id="grResourceType" value="projection"/>
<input name="paramMap.reRecommendID" type="hidden" id="reRecommendID" value="${paramMap.prID}"/>
<input name="paramMap.reRecommendType" type="hidden" id="reRecommendType" value="projection"/>
