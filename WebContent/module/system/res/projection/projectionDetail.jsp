					  ...
					  <tr>
						...
						<table  class="table_9" cellSpacing="1" cellPadding="0" width="100%" border="0" style="background-color: #F5F9FC;">
							<tr class="MeNewTDLine">
								<td align="right" class="tatd" width="15%">影片名称：</td>
								<td class="tatd">${initMap.projInfo.prName}</td>
							</tr>
							<tr class="MeNewTDLine">
								<td align="right" class="tatd" width="10%">资源分类：</td>
								<td  class="tatd">${initMap.projInfo.prCategoryName}</td>
							</tr>
							<s:if test="initMap.projInfo.prOutline != null && initMap.projInfo.prOutline !='' ">
							<tr class="MeNewTDLine">
								<td align="right" class="tatd" width="15%">影片概述：</td>
								<td class="tatd">${initMap.projInfo.prOutline}</td>
							</tr>
							</s:if>
							<s:if test="initMap.projInfo.prThumbnail != null && initMap.projInfo.prThumbnail !='' ">
							<tr class="MeNewTDLine">
