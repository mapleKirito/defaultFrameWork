...
<input type="hidden" id="erTotal" value="${initMap.picDetail.orCategory}">
...
<input type="hidden" id="userType" value="${paramMap.s_userType}">
 ...
 <div id="layout_mainbody"> 
 	 <div class="res-detail-info">
                    <h4><b>资源名称：</b><label>${initMap.picDetail.orName}</label></h4>
                       ...
                       <li title="下载">
		                  	...
		                  	<div class="hide-popup popup-rc-cloud-down">
		                          ...
		                          <div class="hide-popup-content">
		                              <table>
		                              	<s:if test="initMap.picDetail.orAudio != ''&&initMap.picDetail.orType!='1073' "> <tr>
		                                   ...
		                                   <tr>
		                                      <td class="key keya"><a  id="download" href="downloadAction2.action?code=-706&paramMap.resDownRoom=observation&paramMap.resDownType=${initMap.picDetail.orType}&paramMap.resPath=${initMap.picDetail.orUpload}">资源下载</a></td>
		                                  </tr>
		                              </table>
		                          </div>
		                      </div>
                                ...
                                <div class="hide-popup-content">
                                 ...
                                 <tr>
									...
									<tr>
										...
										<td width="75%" align="center" class="orType">${initMap.picDetail.orType eq "1011" ? '高清图片':(initMap.picDetail.orType eq "1073" ? '音频':(initMap.picDetail.orType eq "4033" ? '压缩包':'')) }</td>
									</tr>
									<tr>
                ...
                <div class="page-container">
                    ...
                    <div class="res-detail_x">
                          <c:if test="${initMap.picDetail.orType==1011}">
                            ...
                            <div class="relative-res-container">
                                ...
                                <ul class="res_t" id="relative-res-body_res_t">
                                  ...
                                  <li idInfo='${initMap.picDetail.orID}'>
					     				<a href="javascript:void(0);" audio="${initMap.picDetail.orAudio}" position="${initMap.picDetail.orCityName}"  name="${initMap.picDetail.orName}"  reviewID="${initMap.picDetail.orID}" code="${initMap.picDetail.orCode}" upload="${initMap.picDetail.orUpload}"  inThum="${session.IP}/CacheServer/GetPicInfo?src=${initMap.picDetail.orInThum}"  params="paramMap.path=${initMap.picDetail.orPath}&paramMap.erType=${initMap.picDetail.orFileType}&paramMap.fileType=${initMap.picDetail.orFileType}&paramMap.erID=${initMap.picDetail.orID}&paramMap.st=1&paramMap.temppname=erID&paramMap.temppid=${initMap.picDetail.orID}&paramMap.name=${initMap.picDetail.orName}&paramMap.roomtype=exhibition" >
					     					<img src="${initMap.picDetail.orThumbnail}" onclick="preImg(2,this)"  _index="0"  alt="${initMap.picDetail.orName}"  width="145" height="110"/> 
					     				</a>
					     				<span>
                                   ...
                                   <s:iterator value="initMap.resView" id="fv" status="fvindx">
										<s:if test="#fv.thumbnail!=null">										
						     				...
						     				<a href="javascript:void(0);" audio="${fv.audio}"   name="${fv.name}"  reviewID="${fv.id}" code="${fv.code}" upload="${fv.upload}"  inThum="${session.IP}/CacheServer/GetPicInfo?src=${fv.inThum}"  params="paramMap.path=${fv.path}&paramMap.orType=${fv.fileType}&paramMap.fileType=${fv.fileType}&paramMap.orID=${fv.id}&paramMap.st=1&paramMap.temppname=orID&paramMap.temppid=${fv.id }&paramMap.name=${fv.name}&paramMap.roomtype=observation" >
						     					<img src="${fv.thumbnail}"  onclick="preImg(2,this)" _index="${fvindx.index+1 }" title="${fv.name}" width="145" height="110"/> 
						     				</a>
						     				<span>
