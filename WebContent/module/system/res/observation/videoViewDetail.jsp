...
<style type="text/css">
.hide-popup i.icon-up-arrow{left: 200px;}
</style>
...
$(document).ready(function(){	
	...
	$(".rc-qrcode").click(function(){
		...
		//var st=localhostPaht+"/dm/show_page?id=${initMap.videoDetail.orCode}&pageName=scanner";
		var st=localhostPaht+"/dm/page/scanner/"+code+"/scanner.html";
		art.dialog.data('str', st);
		art.dialog.data('code', "${initMap.videoDetail.orCode}");
		art.dialog.data('contextPath', '<%=request.getContextPath()%>');
...
function fieldControl(){
	...
	if(isFieldNull('${initMap.videoDetail.orCode}')) $(".erCode").parent().remove();
...
.hide-popup i.icon-up-arrow{right: 10px;}
.popup-rc-info{right: 200px;}
...
<input type="hidden" id="orAudio" value="${initMap.videoDetail.orAudio}">
<input type="hidden" id="orUpload" value="${initMap.videoDetail.orUpload}">

<input type="hidden" id="orLongitude" value="${initMap.videoDetail.orLongitude}">
<input type="hidden" id="orLatitude" value="${initMap.videoDetail.orLatitude}">
 	   ...
 	   <div class="res-detail-info">
                    ...
                    <ul class="res-controls">
                       <li title="下载">
		                  	...
		                  	<div class="hide-popup popup-rc-cloud-down rc-cloud-down" style="right: 100px;">
                        ...
                        <li><a href="javascript:void(0);" title="评论" data-type="rc-comment" class="rb rc-comment" id="revR"></a>
                       	 <div id="revM" class="hide-popup popup-rc-comment" style="display: none;">
								...
								<i class="icon-up-arrow"></i>
								<div  class="hide-popup-comment" id="revL" style="width:360px;height:290px;float: left;padding: 10px 0px; background-color: #ae9b84;position: relative;ion: relative;">评论加载中...</div>
                        ...
                        <li>
                            ...
                            <div class="hide-popup popup-rc-info">
                                ...
                                <div class="hide-popup-content">
                                 ...
                                 <table>
                                  <tr>
                                      <td class="key">资源编号</td>
                                      <td id="orCode">${initMap.videoDetail.orNO}</td>
                                  </tr>
                                  <tr>
                                      <td class="key">资源类型</td>
                                      <td id="orCode">
                    ...
                    <div class="res-detail_x">
                        <div class="controll">
                          ...
                          <a href="javascript:void(0);">
							...
							<script type="text/javascript">
							var upload_ = '${initMap.videoDetail.orUpload}';
								upload_ = upload_.substring(0,upload_.lastIndexOf("."))+".mp4";
							//var upload_ = '${initMap.videoDetail.orFileSwf}';
