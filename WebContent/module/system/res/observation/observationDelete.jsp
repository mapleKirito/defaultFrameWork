...
<input name="paramMap.orID" type="hidden" id="orID" value="${paramMap.orID}"/>
<input name="paramMap.rrResourceID" type="hidden" id="rrResourceID" value="${paramMap.orID}"/>
<input name="paramMap.rrResourceType" type="hidden" id="rrResourceType" value="observation"/>
<input name="paramMap.grResourceID" type="hidden" id="grResourceID" value="${paramMap.orID}"/>
<input name="paramMap.grResourceType" type="hidden" id="grResourceType" value="observation"/>
<input name="paramMap.reRecommendID" type="hidden" id="reRecommendID" value="${paramMap.orID}"/>
<input name="paramMap.reRecommendType" type="hidden" id="reRecommendType" value="observation"/>
