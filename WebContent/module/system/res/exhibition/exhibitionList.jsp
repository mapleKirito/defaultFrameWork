...
$(document).ready(function(){	
	...
	var ujdata = {
    	...
    	columnDesc:{
			...
			showColumn: ['erName','erTotal','erCreator'],
			//列表头显示名称
			columnName:   ['资源名称','资源分类','创建人'],
			//列表头宽度
			columnWidth:   ['46%','11%','8%'],
				...
				<td align="left">
					...
					<div class="lt-command">
	 					<s:if test="pmsIndex.res_exhibition_room_create">
	 						<a href="decorateForwardAction.action?code=${pmsIndex.res_exhibition_room_create.code}" class="fade-button" data-old-bg="rgb(124, 109, 91)" style="background-color: rgb(124, 109, 91);">
					 	...
					 	<s:if test="pmsIndex.res_exhibition_room_welcome_manager">
					 		<a href="decorateForwardAction.action?code=${pmsIndex.res_exhibition_room_welcome_manager.code}">
