                    ...
                    <ul class="res-controls">
                       ...
                       <li title="下载">
		                ...
		                <s:if test="session.s_userType != 3 and paramMap.st == 1 and session.s_userType != 5">
		                 ...
		                 <c:if test="${initMap.picDetail.erCountry <3238 }">
                       ...
                       <%-- <s:if test="session.s_userType != 3 and paramMap.st == 1 and session.s_userType != 5">  --%>
	                        ...
	                        <li><a href="javascript:void(0);" title="评论" data-type="rc-comment" class="rb rc-comment" id="revR" ></a>
									...
									<i class="icon-up-arrow"></i>
									<div  class="hide-popup-comment" id="revL" style="width:360px;height:290px;float: left;padding: 10px 0px; background-color: #ae9b84;position: relative;">评论加载中...</div>
								</div>
                        ...
                        <div class="controll">
                           ...
                           <div class="res-detail-container">
                            ...
                            <a href="javascript:void(0);" onclick="BigImg('er')">
                           	 <img onload="if(this.width >= ${session.imgWidth}){this.height=(this.height/this.width)*${session.imgWidth};this.width = ${session.imgWidth};}if(this.height >= ${session.imgHeight}){this.width=(this.width/this.height)*${session.imgHeight};this.height = ${session.imgHeight};}" id="resView" src="${initMap.picDetail.erInThum}" upload='${initMap.picDetail.erUpload}'  _index="0"  alt="${initMap.picDetail.erName}"/>
                            </a>
                        </div>
                    </div>
                    <!--资源详细结束-->
                            ...
                            <div class="relative-res-container">
                                ...
                                <ul class="res_t" id="relative-res-body_res_t">
	                              	...
	                              	<li idInfo='${initMap.picDetail.erID}'>
					     				<a href="javascript:void(0);" audio="${initMap.picDetail.erAudio}" position="${initMap.picDetail.erCityName}"  name="${initMap.picDetail.erName}"  reviewID="${initMap.picDetail.erID}" code="${initMap.picDetail.erCode}" upload="${initMap.picDetail.erUpload}"  inThum="${initMap.picDetail.erInThum}"  params="paramMap.path=${initMap.picDetail.erPath}&paramMap.erType=${initMap.picDetail.erFileType}&paramMap.fileType=${initMap.picDetail.erFileType}&paramMap.erID=${initMap.picDetail.erID}&paramMap.st=1&paramMap.temppname=erID&paramMap.temppid=${initMap.picDetail.erID}&paramMap.name=${initMap.picDetail.erName}&paramMap.roomtype=exhibition" >
					     					<img src="${initMap.picDetail.erThumbnail}" onclick="preImg(2,this)"  _index="0"  alt="${initMap.picDetail.erName}"  width="145" height="110"/> 
					     				</a>
					     				<span>
										...
										<s:if test="#fv.thumbnail!=null">										
						     				<li idInfo='${fv.id}'>
							     				<a href="javascript:void(0);" audio="${fv.audio}" position="${fv.position}"  name="${fv.name}"  reviewID="${fv.id}" code="${fv.code}" upload="${fv.upload}"  inThum="${fv.inThum}"  params="paramMap.path=${fv.path}&paramMap.erType=${fv.fileType}&paramMap.fileType=${fv.fileType}&paramMap.erID=${fv.id}&paramMap.st=1&paramMap.temppname=erID&paramMap.temppid=${fv.id }&paramMap.name=${fv.name}&paramMap.roomtype=exhibition" >
							     					<img src="${fv.thumbnail}" onclick="preImg(2,this)"  _index="${fvindx.index+1}"  alt="${fv.name}"  width="145" height="110"/> 
							     				</a>
							     				<span>
