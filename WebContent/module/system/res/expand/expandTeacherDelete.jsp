...
<input name="paramMap.rrResourceType" type="hidden" id="rrResourceType" value="expand"/>
<input name="paramMap.grResourceID" type="hidden" id="grResourceID" value="${paramMap.erID}"/>
<input name="paramMap.grResourceType" type="hidden" id="grResourceType" value="expand"/>
