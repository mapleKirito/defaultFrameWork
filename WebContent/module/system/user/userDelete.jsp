...
<input type="hidden" name="paramMap.userType" value="${paramMap.userType}"> 
								...
								<table width="100%" height="130" border="0" cellpadding="0" cellspacing="0" class="tableC">
									<tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1" class="">
											<tr>
												<td align="center">
													<s:if test="initMap.taskInfocount > 0" >
														<s:if test="paramMap.userType == 2" >
															此用户已经关联对老师留得作业或者老师对此用户帐号提出的问题做出的回复。
														</s:if>
														<s:if test="paramMap.userType == 1 " >
															此用户已经关联老师向学生留得作业或者对学生提出的问题做出的回复。
														</s:if>
													</s:if>
													是否确认要删除所选择的记录？
													<s:if test="initMap.taskInfocount > 0" >
