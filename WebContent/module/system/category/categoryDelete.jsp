...
<input type="hidden" name="paramMap.cateParentID" value="${paramMap.cateParentID}">
<input type="hidden" name="paramMap.cateID" value="${paramMap.cateID}">
