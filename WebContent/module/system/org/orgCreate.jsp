...
$(document).ready(function() {
	...
	$("#orgName").formValidator({onshow:"请输入班级名称",onfocus:"请输入班级名称",oncorrect:"输入正确"}).inputValidator({min:1,onerror:"班级名称不能为空,请确认"});
});
</script>
</head>
<body >
...
<input type="hidden" name="paramMap.orgParentID" value="0"> 
<input type="hidden" name="paramMap.orgLevel" value="1"> 
<input type="hidden" name="paramMap.orgStatus" value="1"> 
								...
								<form name="actionForm" method="post" action="operateAction.action" id="actionForm">
									<table class="table_9" cellSpacing="1" cellPadding="0" width="100%" border="0" style="background-color: #F5F9FC;">
										<tr bgcolor="#ae9b84">                
											...
											<td class="tatd"><input name="paramMap.orgName" type="text" maxlength="180" id="orgName"  style="width: 200px;" />&nbsp;<font color="red">*</font><span id="orgNameTip" style="position:absolute;height:22px;width:250px"></span></td>
										</tr>
										<tr bgcolor="#ae9b84">
											<td align="right" class="tatd">班级描述：</td>
											<td class="tatd"><input name="paramMap.orgDesc" type="text" maxlength="100" id="orgDesc" style="width: 400;" /></td>
										</tr>
