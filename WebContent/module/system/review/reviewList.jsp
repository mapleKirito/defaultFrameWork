...
$(document).ready(function(){
	...
	var ujdata = {
    	...
    	shortcut:{
	    	...
	    	width:'29%',
	    	event:[
				{operate:'preview',name:'${pmsIndex.review_res_preview.name}',disabled:'false',isvalid:'${!empty pmsIndex.review_res_preview}',param:'favorite_'},
    	...
    	columnDesc:{
			...
			showColumn: ['srUserName','srContent','srTime','resName'],
			//列表头显示名称
			columnName:   ['评论人','评论内容','评论时间','所属资源名称'],
			//列表头宽度
