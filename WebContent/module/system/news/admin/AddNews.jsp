									...
									<tr bgcolor="#ae9b84">
										...
										<td width="85%" class="tatd" align="left">
											<textarea name="paramMap.newsContent" id="newsContent" style="display:none"></textarea>
									   		<script type="text/javascript">
									   		CKEDITOR.replace('newsContent',{ filebrowserUploadUrl : 'ckeditor/uploader?Type=File&TypeRoom=addnews', filebrowserImageUploadUrl : 'ckeditor/uploader?Type=Image&TypeRoom=addnews', filebrowserFlashUploadUrl : 'ckeditor/uploader?Type=Flash&TypeRoom=addnews' });
											</script>
										</td>
									</tr>
