...
<input type="hidden" name="paramMap.areaParentID" value="${paramMap.areaParentID}">
<input type="hidden" name="paramMap.areaID" value="${paramMap.areaID}">
