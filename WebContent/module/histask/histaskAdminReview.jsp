...
<input name="paramMap.htaskID" type="hidden" id="htaskID" value="${paramMap.htaskID}"/>
<input type="hidden" name="imitateStep" value="${pmsIndex.sys_histask_param.imitationStep}">
