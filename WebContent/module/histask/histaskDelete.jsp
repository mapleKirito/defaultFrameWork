...
<input type="hidden" name="paramMap.htaskID" value="${paramMap.htaskID}"> 
<input type="hidden" name="imitateStep" value="sys_histask_param_step_1">
								...
								<table width="100%" height="130" border="0" cellpadding="0" cellspacing="0" class="tableC">
									<tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1" class="">
											<tr>
												<td align="center" valign="middle">  &nbsp;是否确认要删除所选择的记录？</td>
											</tr>
										</table>
										</td>
									</tr>
