...
<input type="hidden" value="0" name="paramMap.userRecom" id="userRecom"/>
<input name="paramMap.userID" type="hidden" id="userID" value="${paramMap.userID}"/>
<input type="hidden" name="imitateStep" value="${pmsIndex.the_space_mgr.imitationStep}">
