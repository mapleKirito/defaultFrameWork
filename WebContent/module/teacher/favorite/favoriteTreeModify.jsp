...
var setting = {
	async: {
		enable: true,
		url:"ajaxAction.action?code=-701015",
		dataType:"json",
		autoParam:["id"],
		dataFilter: filter
	},
...
<input type="hidden" name="paramMap.rfId" id="rfId" value="${initMap.favorite.rfId}"/>
<input type="hidden" name="paramMap.oldParentId" id="oldParentId" value="${initMap.favorite.rfParentId}"/>
<input type="hidden" name="paramMap.rfPath" id="rfPath" value="${initMap.favorite.rfPath}"/>
<input type="hidden" name="code" value="002002002"> 
						...
						<td width="100%" bgcolor="#E8E8E8" valign="top">
							<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9" >
								 <tr bgcolor="#ae9b84">
									...
									<input name="paramMap.rfParentId" type="hidden"  maxlength="180" id="rfParentId" style="width: 200px;" value="${initMap.favorite.rfParentId}" /> 
								    <input name="paramMap.rfParentName" type="text" maxlength="180" readonly id="rfParentName" value="${initMap.favorite.rfParentName}" style="width: 200px;"/> 
								  ...
								  <s:if test="paramMap.rfParentId != 0">
								  <tr id="inputName" bgcolor="#606373">
									<td width="15%" class="tatd" align="right">当前目录：</td>
									<td width="85%" class="tatd" align="left">
									<input name="paramMap.rfName" type="text" maxlength="180" id="rfName" value="${initMap.favorite.rfName}" style="width: 200px;" />&nbsp;
								  ...
								  <s:if test="paramMap.rfParentId == 0">
									  <tr id="inputName" style="display:none;" bgcolor="#606373">
										<td width="15%" class="tatd" align="right">当前目录：</td>
										<td width="85%" class="tatd" align="left">
										<input name="paramMap.rfName" type="text" maxlength="180" id="rfName" value="${initMap.favorite.rfName}" style="width: 200px;" />&nbsp;
										<font color="red">*</font><span id="rfNameTip" style="position:absolute;height:22px;width:250px"></span>
									  ...
									  <tr id="selectName" bgcolor="#606373">
										<td width="15%" class="tatd" align="right">当前目录：</td>
										<td width="85%" class="tatd" align="left">
										<select name="paramMap.rfSelectName" id="rfSelectName" style="width:200px;">
											<s:if test="initMap.favorite.rfSort == 'exhibition'">
											  <option value="exhibition" selected="selected">文物博览室</option>
											  <option value="observation">专题研读室</option>
											  <option value="laboratory">教学研究室</option>
											  <option value="projection">影像资料室</option>
											  <option value="expand">自主探究室</option>			
											</s:if>
											<s:if test="initMap.favorite.rfSort == 'observation'">
											  <option value="exhibition">文物博览室</option>
											  <option value="observation" selected="selected">专题研读室</option>
											  <option value="laboratory">教学研究室</option>
											  <option value="projection">影像资料室</option>
											  <option value="expand">自主探究室</option>			
											</s:if>
											<s:if test="initMap.favorite.rfSort == 'laboratory'">
											  <option value="exhibition">文物博览室</option>
											  <option value="observation">专题研读室</option>
											  <option value="laboratory" selected="selected">教学研究室</option>
											  <option value="projection">影像资料室</option>
											  <option value="expand">自主探究室</option>			
											</s:if>
											<s:if test="initMap.favorite.rfSort == 'projection'">
											  <option value="exhibition">文物博览室</option>
											  <option value="observation">专题研读室</option>
											  <option value="laboratory">教学研究室</option>
											  <option value="projection" selected="selected">影像资料室</option>
											  <option value="expand">自主探究室</option>			
											</s:if>
											<s:if test="initMap.favorite.rfSort == 'expand'">
											  <option value="exhibition">文物博览室</option>
											  <option value="observation">专题研读室</option>
											  <option value="laboratory">教学研究室</option>
											  <option value="projection">影像资料室</option>
											  <option value="expand" selected="selected">自主探究室</option>			
											</s:if>									
										</select>
										<font color="red">*</font><span id="rfSelectNameTip" style="position:absolute;height:22px;width:250px"></span>
										</td>
