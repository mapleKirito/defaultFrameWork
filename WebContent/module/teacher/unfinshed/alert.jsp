...
<input type="hidden" name="paramMap.studentID" value="${paramMap.studentID}"> 
<input type="hidden" name="paramMap.tID" value="${paramMap.tID}"> 
<input type="hidden" name="imitateStep" value="task_unfinished_manager_user_step">
								...
								<table width="100%" height="130" border="0" cellpadding="0" cellspacing="0" class="tableC">
									<tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="1" class="">
											<tr>
												<td align="center" valign="middle">  &nbsp;是否确认要提示选择的用户？</td>
											</tr>
										</table>
										</td>
									</tr>
