...
$(document).ready(function(){	
	...
	$("#answerType").formValidator({onshow:"请选择密码提示问题",onfocus:"密码提示问题必选",oncorrect:"输入正确"}).inputValidator({min:1,onerror:"密码提示问题不能为空"});
	
});
function modify(_this){
	//window.parent.tabClick('002013','修改','-600102','');
	location.href="decorateForwardAction.action?code=-600102&suijichileren="+new Date();
}
</script>
</head>
<body>
...
<input type="hidden" name="imitateStep" value="teacher_info_1"> 
							...
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
								  <tr bgcolor="#ae9b84">
									...
									<img src="${(initMap.userInfo.userImg==null||initMap.userInfo.userImg=='')?'images/main/toux.jpg':initMap.userInfo.userImg}?suiji=<%=new Random().nextInt() %>" width="145" height="147">
								  ...
								  <tr bgcolor="#ae9b84">
									<td width="15%" class="tatd" align="right">推送关键字：</td>
									<td width="85%" class="tatd" align="left">
									<input name="paramMap.resLike" value="${initMap.userInfo.resLike}" type="text" maxlength="180" id="resLike"  style="width: 200px;" />&nbsp;
									<font color="red">*</font><span id="nameTip" style="position:absolute;height:22px;width:250px">多个关键字用“,”(英文逗号)区分</span>
									</td>
								  </tr>
								  <tr bgcolor="#ae9b84">
									<td width="15%" class="tatd" align="right">qq：</td>
									<td width="85%" class="tatd">
									<input name="paramMap.qq" id="qq" value="${initMap.userInfo.qq}" type="text" maxlength="200" style="width: 200px;" />&nbsp;
									</td>
								  </tr>
								  <tr bgcolor="#ae9b84">
