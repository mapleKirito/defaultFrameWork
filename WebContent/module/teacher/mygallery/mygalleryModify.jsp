							...
							<div>
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
									 <tr bgcolor="#ae9b84">
										...
										<input type="hidden" name="paramMap.oldgaSrc" id="oldgaSrc" value="${initMap.gagelleryInfo.gaSrc}" >
										<input type="hidden" name="paramMap.gaSrc" id="gaSrc" value="${initMap.gagelleryInfo.gaSrc}">
										</td>
									</tr>
									<tr bgcolor="#ae9b84">
										<td width="15%" class="tatd" align="right" id="exhibition_17">详细说明：</td>
										<td width="85%" class="tatd" align="left">
										<textarea cols="80" id="gaDescription" name="paramMap.gaDescription" rows="10">${initMap.gagelleryInfo.gaDescription}</textarea>&nbsp;
