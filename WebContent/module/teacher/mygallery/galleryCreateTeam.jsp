...
<input type="hidden" name="imitateStep" value="${pmsIndex.tea_images_mgr_team.imitationStep}">
<input type="hidden" name="paramMap.gaUserID" value="${session.s_userID }"> 
<input type="hidden" name="paramMap.teamID" value="${paramMap.tID }"> 
<input type="hidden" name="paramMap.gaParentId" value="${paramMap.gaParentId }"> 
