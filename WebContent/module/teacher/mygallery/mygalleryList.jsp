				...
				success:function(jsonData,textStatus){
					if (textStatus == "success"){
						if(jsonData.flag>0){
							...
							//liObj.parent().remove();
							window.location.href="decorateForwardAction.action?code=${pmsIndex.tea_images_mgr.code}&paramMap.userID=${s_userID}&suijichileren="+new Date();
						}
					}
				}
			}); 
			...
			<p class="title topborder">
				...
				<span>
					<s:if test="paramMap.userID==#session.s_userID">
						<a href="decorateForwardAction.action?code=002032008001">添加相册</a> 
					</s:if>
				</span>
			</p>
			<div class="body">
						...
						<li class="mem_class" style="height: 160px;padding-top: 6px;" ><s:if
							...
							<div class="imgDiv" >
								<span></span> <a   title="${t.gaDescription }" 
									href="javascript:void(0);"  onclick="toxiangce('${t.gaID }');">
