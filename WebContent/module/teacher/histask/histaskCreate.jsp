...
$(document).ready(function(){	
	...
	$(".table_9_addren img").die().live("click", function() {
		...
		if(numren<10){
			//if (firsthtaskManyTitle != "" && sibinput != "") {
				$(this).remove();
...
<input type="hidden" name="imitateStep" value="tea_task_param_step_2">
							...
							<table id="createtable9" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_9">
							  <tr bgcolor="#ae9b84">
								<td width="15%" class="tatd" align="right">问题标题：</td>
									...
									<font color="red">*</font><span id="htaskTitleTip"  style="height:22px;width:250px;"></span>									
								</td>
							  </tr>
							  <tr bgcolor="#ae9b84" >
								...
								<td width="85%" class="tatd" align="left">
									...
									&nbsp;<font color="red">*</font><span id="htaskClassTip" style="height:22px;width:203px"></span>								</td>
							  </tr> 
							  <tr bgcolor="#ae9b84">
