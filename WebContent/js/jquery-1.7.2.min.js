...
jQuery.fn.LoadImage = function(scaling, width, height, loadpic) {
	...
	var rightFrameWidth = $(window).width();
	//alert($(window).width());
	return this.each(function() {
		var t = $(this);
				...
				if (img.width > 0 && img.height > 0) {
					if (img.width / img.height >= width / height) {
						if (img.width > width) {
							...
							t.parent().siblings("span").css({"left":(rightFrameWidth-width)/2,"width":width});
						} else {
							t.width(img.width);
							t.height(img.height);
							//t.css("margin-top", (height - t.height()) / 2);
							t.parent().siblings("span").css({"left":(rightFrameWidth-img.width)/2,"width":img.width});
						}
					} else {
						if (img.height > height) {
							...
							//t.css("margin-top", (height - t.height()) / 2);
							t.parent().siblings("span").css({"left":(rightFrameWidth - ((img.width * height) / img.height))/2,"width":(img.width * height) / img.height});
						} else {
							t.width(img.width);
							t.height(img.height);
							//t.css("margin-top", (height - t.height()) / 2);
...
$(function(){
	...
	$(".pageb #pageBack").click(function(){
		...
		var courselistavalue = $("#course-list-a-value").val();
		...
		if (courselistavalue){
			url += "&paramMap.courselistavalue=" + courselistavalue;
		}
