		...
		if(succeva!=''){
			$.ajax({
				...
				success : function(jsonData, textStatus) {
					 if(jsonData.istrue==1){alert("注册成功，请重新启动服务！")}
					 else{alert("您填写有误!");}
				},
				//ajax请求错误后调用函数
...
<BODY  onload="getBefore();"  style="  background: rgb(187, 171, 155);">
	<DIV>
		<form>
							...
							<table align="center" height="357" width="727" border="0" cellpadding="0" cellspacing="0" style="padding-top:45px;  background-image: url('images/xtzc1.png');  ">
								...
								<tr height="20px">
									<td colspan="3" height="0" valign="top" align="left"   style="padding-left: 150px;">
										<p>
										请将机器码、序列号发至linktones@126.com邮箱<br /><br />或拨打电话询问注册码&nbsp;010-56258959&nbsp;&nbsp;010-56258960&nbsp;&nbsp;&nbsp;&nbsp;</p>
									</td>
								</tr>
								<tr height="20px">
